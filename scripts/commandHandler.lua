...
function commandHandler.ProcessCommand(pid, cmd)
    ...
    elseif (
            -- custom.atkana.kanaRevive
            cmd[1] == "die" or

            -- custom.atkana.kanaBank
            cmd[1] == "bank" or

            -- custom.atkana.decorateHelp
            cmd[1] == "decorator" or
            cmd[1] == "decorate" or
            cmd[1] == "dh" or

            -- custom.atkana.kanaFurniture
            cmd[1] == "furniture" or
            cmd[1] == "furn" or

            -- custom.atkana.kanaHousing
            cmd[1] == "houseinfo" or
            cmd[1] == "house" or
            cmd[1] == "housing" or
            cmd[1] == "adminhouse" or
            cmd[1] == "adminhousing" or

            -- custom.atkana.CellReset
            cmd[1] == "resettime" or
            cmd[1] == "forcereset" or

            -- custom.lear.objectSpawnSystem
            cmd[1] == "sobj" or

            -- custom.lear.modActionMenu
            cmd[1] == "mm" or
            cmd[1] == "modmenu" or
