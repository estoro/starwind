...
config.defaultSpawnCell = "Tatooine, Sandriver"

-- The X, Y and Z position that newly created players are teleported to
config.defaultSpawnPos = {2784, 10148, 12352}
...
config.defaultRespawnCell = "Tatooine, Sandriver"

-- The X, Y and Z position that players respawn in
config.defaultRespawnPos = {2784, 10148, 12352}

-- The X and Z rotation that respawned players are assigned
config.defaultRespawnRot = {0, 1.2}
