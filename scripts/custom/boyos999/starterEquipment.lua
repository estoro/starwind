...
starterEquipment.GiveStarterItems = function(eventStatus, pid)
    ...
    inventoryHelper.addItem(Players[pid].data.inventory, "portable_bedroll", 1)
    inventoryHelper.addItem(Players[pid].data.inventory, "sw_medkit", 2)
    inventoryHelper.addItem(Players[pid].data.inventory, "sw_vibrobladeimbold", 1)
    inventoryHelper.addItem(Players[pid].data.inventory, "sw_securityspike", 2)
    inventoryHelper.addItem(Players[pid].data.inventory, "sw_blasterrifleworn", 1)
    inventoryHelper.addItem(Players[pid].data.inventory, "sw_rephelm", 1)
    inventoryHelper.addItem(Players[pid].data.inventory, "common_shirt_04_a", 1)
