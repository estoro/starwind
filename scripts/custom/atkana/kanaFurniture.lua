...
{name = "Training Terminal", refId = "sw_terminaltraining", price = 50},
-- container
{name = "Chest", refId = "sw_chestrandom", price = 50},
{name = "Crate", refId = "sw_crate", price = 50},
{name = "Med Crate", refId = "sw_cratemedical", price = 50},
...
{name = "Droid Sign", refId = "sw_ext_signdroids", price = 50},
{name = "Barrel", refId = "sw_furnbarrel", price = 50},
